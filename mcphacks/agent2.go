...
func main() {
	...
	if chatLLM = os.Getenv("CHAT_LLM"); chatLLM == "" {
		...
		chatLLM = "llama3.2:3b"
		//chatLLM = "llama3.2:3b-instruct-q8_0"
		//chatLLM = "llama3.2:3b-instruct-fp16"
	}
	...
	if toolsLLM = os.Getenv("TOOLS_LLM"); toolsLLM == "" {
		...
		//toolsLLM = "llama3.2:3b"
		//toolsLLM = "llama3.2:3b-instruct-q8_0"
	...
	`
	//userInstructions := `Fetch this page: https://raw.githubusercontent.com/docker-sa/01-build-image/refs/heads/main/main.go and then analyse the source code.`
	...
	//userInstructions := `1. send 100 tokens from alice to bob`
	...
	contentForThePrompt := ""
	//contentForThePrompt := "budget optimization"
